 ...
 */
public class FreshLinearLayout extends LinearLayout {
    ...
    public FreshLinearLayout(Context context) {
        this(context, null);
    }

    public FreshLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public FreshLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
